...
export const NOTIFICATION_TYPES: NotificationTypeDef[] = [
  ...
  { value: "ads_daily_report", label: "Resumen diario de anuncios", description: "Cada mañana te enviamos el análisis IA del día anterior con recomendaciones.", roles: ["ceo"] },
];
